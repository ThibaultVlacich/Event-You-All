...
<div class="note error">
  ...
  <ul>
    <li>La Région demandée n'existe pas !</li>
  </ul>
</div>
<?php
    return;
...
<div class="app-events app-events-create">
  <h1 class="app-title">Modifier la Région (Admin)</h1>
  <form method="post" action="<?php echo Config::get('config.base'); ?>/admin/events/modif_confirm_region/<?php echo $model['id'];?>" enctype="multipart/form-data">
    <div class="form-main">
      <div class="form-block full">
        <h3 class="form-block-title">&Agrave; propos de la Région</h3>
