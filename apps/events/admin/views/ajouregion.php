<div class="app-events app-events-create">
  <h1 class="app-title">Ajouter une Region (Admin)</h1>
  <form method="post" action="<?php echo Config::get('config.base'); ?>/admin/events/add_confirm_region" enctype="multipart/form-data">
    <div class="form-main">
