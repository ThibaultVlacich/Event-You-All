...
<html>
    <head>
        ...
        <link rel="stylesheet" href="A%20propos.css"/>
    </head>
    <body>
        <div id="bandeau">
            <h1>A propos d' Event-You-All</h1>
        </div>
        ...
        <img src="<?php echo Config::get('config.base')?>/apps/about/Image/logo.png" alt="Logo Event-You-All" />
    </body>
</html>
